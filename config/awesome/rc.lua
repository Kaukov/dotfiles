...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
			...
			battery_widget({ show_current_level = true, display_notification = true, notification_position = "bottom_right" }),
            mytextclock,
            s.mylayoutbox,
        },
    }
...
globalkeys = gears.table.join(globalkeys,
  ...
  awful.key({}, "XF86AudioMicMute", function ()
    -- awful.util.spawn("amixer set Capture toggle", false)
